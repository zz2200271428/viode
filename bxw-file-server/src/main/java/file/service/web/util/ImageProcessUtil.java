...
public class ImageProcessUtil {
    private static final Log logger = LogFactory.getLog(ImageProcessUtil.class);
    // ===源图片路径名称如:c:\1.jpg
     ...
     * @throws IOException 放大图像不会导致失真，而缩小图像将不可避免的失真。
     *                     <p>
    ...
    public static boolean ratioZoom(File srcFile, String dest, String newFileName, String suffix, int newWidth,
        ...
        Image Itemp = Bi.getScaledInstance(newWidth, newHeight, Image.SCALE_REPLICATE);
    ...
    public static void ratioZoom2(File src, File dist, double ratio0) {
        try {
            ...
            ratioZoom2(fileStream, dist, ratio0);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @param dist 目标图片文件完整路径
     */
    public static void ratioZoom2(InputStream stream, File dist, double ratio0) {
        FileOutputStream os = null;
        try {
            BufferedImage image = ImageIO.read(stream);
            if (ratio0 <= 0) {
                ratio0 = image.getHeight();
            }
            ...
            ImageIO.write(bfImage, FileItem.getExtensionName(dist.getName()), dist);
    ...
    public static void main(String[] args) {
        try {
            if (ImageProcessUtil.ratioZoom(new File("D:/images/zb.jpg"), "D:/var", "aaaa", "jpg", 300, 300)) {
        ...
        ratioZoom2(new File("D:/images/zb.jpg"), new File("D:/var/99999.jpg"), 300d);
    }
}
